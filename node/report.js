...
class ReportGenerator {
    createReport(target, provider, baseUrl, checks, duration) {
    ...
    generateMarkdown(report) {
        ...
        for (const checkName in report.checks) {
            ...
            lines.push(`### ${checkName.charAt(0).toUpperCase() + checkName.slice(1)} ${statusIcon[status] || '•'}`);
            lines.push('');
